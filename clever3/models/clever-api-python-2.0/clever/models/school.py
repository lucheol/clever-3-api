...
class School(object):
    ...
    def __init__(self, created=None, district=None, high_grade=None, id=None, last_modified=None, location=None, low_grade=None, mdr_number=None, name=None, nces_id=None, phone=None, principal=None, school_number=None, sis_id=None, state_id=None):  # noqa: E501
