...
class District(object):
    ...
    def __init__(self, error=None, id=None, last_sync=None, launch_date=None, mdr_number=None, name=None, nces_id=None, pause_end=None, pause_start=None, sis_type=None, state=None):  # noqa: E501
